...
void RemoteCommInit(BadDataPackCb_t callback)
{
    ...
    xTaskCreate(SendDataPackTask, "uartSendTask", 256, NULL, 5, NULL);
    xTaskCreate(ReceiveDataPackTask, "uartRecvTask", 256, callback, 5, NULL);
    xTaskCreate(ACKTimeoutCheckTask, "uartackTask", 256, NULL, 3, NULL);
}
